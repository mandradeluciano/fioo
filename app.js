// ===========================================================================
// Aleth — memória de trabalho do time (de "aletheia", grego: o não-esquecimento)
...
// toque/clique na marca explica a origem do nome (bom para mobile)
["brand-top", "brand-login"].forEach((id) => {
  const el = document.getElementById(id);
  if (el) el.addEventListener("click", () =>
    toast("Aleth — de aletheia (grego): a- (não) + lethe (esquecimento) = o não-esquecimento."));
});
